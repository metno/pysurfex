...
class BaseNamelist(object):
    def __init__(self, program, config, input_path, system_file_paths, **kwargs):
        ...
        self.namelist = surfex.ascii2nml(merged_json_settings)
        self.ecoclimap = surfex.JsonInputData(ecoclimap_json)
        self.input_data = surfex.JsonInputData(input_for_surfex_json)
